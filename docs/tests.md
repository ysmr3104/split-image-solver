...
| equidistant_12x8 | AstrHori 6.5mm F2.0 Fish-Eye | Sony α6100 | 6024 x 4024 | 12 x 8 | equidistant |
...
| テスト種別 | ファイル |
|-----------|---------|
| IT-Solver Local | `tests/it/local/test_solver_equidistant_12x8.py` |
...
### equidistant_12x8 (AstrHori 6.5mm 超広角魚眼) — 9/96 成功
