#!/usr/bin/env node
/**
 * test_wavefront_8x6.js — IT-Wavefront API (8x6, 14mm rectilinear)
 *
 ...
 *   ASTROMETRY_API_KEY=xxx node tests/it/api/test_wavefront_8x6.js
 */
...
console.log("IT-Wavefront API (8x6, 14mm rectilinear)");
