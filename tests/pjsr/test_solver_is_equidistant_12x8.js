...
// 解けたタイル数を検証する（tests/it/local/test_solver_equidistant_12x8.py の IS 版）
//
// 前提:
...
// Test
// ============================================================
test("IS Tile Solve equidistant_12x8: batch_success tiles solved >= " + BASELINE_MIN_SOLVED, function() {
