// test_wavefront_is_equisolid_8x6.js
// Wavefront grid test using ImageSolver (8x6, Sigma 15mm equisolid fisheye)
//
// Prerequisites:
//   - AdP ImageSolver must be installed in PixInsight
//   - Tile FITS files must exist in tests/fits_downsampling/equisolid_8x6/
//
// Test strategy:
...
var RESULT_PATH = PROJECT_ROOT + "tests/pjsr/results/test_wavefront_is_equisolid_8x6_result.json";
...
function getWavefrontResult() {
    ...
    var hints = {
        ...
        _projection:  fh.projection || "equisolid"
    };
    ...
    var tilesJsonPath = PROJECT_ROOT + "tests/pjsr/results/test_wavefront_is_equisolid_8x6_tiles.json";
    var debugEntries = [];
...
test("wavefront equisolid_8x6: solved tile count >= baseline (" + BASELINE_MIN_SOLVED + ")", function() {
