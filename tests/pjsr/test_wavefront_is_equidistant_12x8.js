...
// Local solver (solve-field) baseline: 12/96
var BASELINE_MIN_SOLVED = 9;
...
function getWavefrontResult() {
    ...
    var tilesJsonPath = PROJECT_ROOT + "tests/pjsr/results/test_wavefront_is_equidistant_12x8_tiles.json";
    var debugEntries = [];
